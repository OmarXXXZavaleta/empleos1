...
public class HomeController {
	...
	//metodo paramanipular diverso tipos de datos
	@GetMapping("/vacante")
	...
	//un metodo que rregrese untipo vacante
	@GetMapping("/detalles")
	public String detalles(Model model) {
		Vacante v= new Vacante();
		System.out.println(v);
		v.setId(100);
		v.setNombre("Ingeniero Electrico");
		v.setDescripcion("Relaciona con alicaciones IOT");
